...
/// 屏幕方向
@property (nonatomic, assign, readonly) UIDeviceOrientation type;
...
/// 按钮上下间隔
@property (nonatomic, assign) CGFloat btnHeightSpace;
/// 按钮左右间隔
@property (nonatomic, assign) CGFloat btnWidthSpace;
/// 背景界面frame
